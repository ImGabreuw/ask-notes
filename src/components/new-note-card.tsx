...
function NewNodeCard({ onNoteCreated }: NewNoteCardProps) {
          ...
          <form className="flex-1 flex flex-col">
            ...
            {isRecording ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300 outline-none font-md hover:text-slate-100"
              >
